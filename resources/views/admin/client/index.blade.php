...
@section('content')
    <div class="container mx-auto max-w-7xl">
        <div class="flex justify-between items-center mb-6">
            ...
            <a href="{{ route('admin.client.create') }}" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition">
                            ...
                            <tr class="hover:bg-slate-50 dark:hover:bg-slate-700/50 transition">
                                ...
                                <td class="px-6 py-4 text-right">
                                    <div class="flex items-center justify-end space-x-3">
                                        <a href="{{ route('admin.client.view', $client->client_id) }}" class="text-blue-600 hover:text-blue-800 font-medium flex items-center" title="View Details">
                                            View Details <i class="fa-solid fa-arrow-right ml-1"></i>
                                        </a>
                                        <div class="h-4 w-px bg-slate-300 dark:bg-slate-600 mx-2"></div>
                                        <a href="{{ route('admin.client.edit', $client->client_id) }}" class="text-indigo-600 hover:text-indigo-800" title="Edit">
                                            <i class="fa-solid fa-pen"></i>
                                        </a>
                                        <a href="{{ route('admin.client.delete', $client->client_id) }}" class="text-red-600 hover:text-red-800" title="Delete" onclick="return confirm('Are you sure?')">
