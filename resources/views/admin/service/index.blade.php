...
@section('content')
    <div class="container mx-auto max-w-7xl">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-bold text-slate-800 dark:text-white">Services</h1>
                        ...
                        @forelse($services as $service)
                            <tr class="hover:bg-slate-50 dark:hover:bg-slate-700/50 transition">
                                ...
                                <td class="px-6 py-4 text-right space-x-2">
                                    <a href="{{ route('admin.service.edit', $service->service_id) }}"
                                        class="text-indigo-600 hover:text-indigo-800" title="Edit">
                                        <i class="fa-solid fa-pen"></i>
                                    </a>
                                    <a href="{{ route('admin.service.delete', $service->service_id) }}"
