                        ...
                        <div class="space-y-4">
                            <div>
                                <label class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">Company
                                    Description</label>
                                <textarea rows="4"
                                    class="w-full rounded-lg border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-900 text-slate-800 dark:text-slate-200 focus:border-blue-500 focus:ring-blue-500"
                                    placeholder="Enter company description here..."></textarea>
                            </div>
                            <button type="button"
                                class="w-full px-4 py-2 bg-slate-800 dark:bg-slate-700 text-white rounded-lg hover:bg-slate-700 dark:hover:bg-slate-600 transition">
                                Save Information
                            </button>
                        </div>
                    </form>
