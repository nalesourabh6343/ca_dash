...
@section('content')
    <div class="container mx-auto max-w-7xl">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <!-- Left Column: User Card & About Us -->
            <div class="lg:col-span-1 space-y-8">
                
                <!-- User Card -->
                <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 p-6 text-center relative overflow-hidden">
                    ...
                    <div class="relative z-10 mt-12">
                         <div class="w-24 h-24 bg-white dark:bg-slate-800 rounded-full mx-auto p-1 shadow-lg">
                            <div class="w-full h-full bg-slate-200 dark:bg-slate-700 rounded-full flex items-center justify-center text-2xl font-bold text-slate-600 dark:text-slate-300">
                        ...
                        <div class="mt-6 flex justify-center gap-3">
                            <span class="px-3 py-1 text-xs font-semibold rounded-full bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400">
                                Administrator
                            </span>
                        </div>
                    </div>
            ...
            <div class="lg:col-span-2 space-y-8">
                ...
                <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 p-6">
                    ...
                    <form method="post" action="{{ route('password.update') }}" class="space-y-6">
                        ...
                        <div>
                            <label for="current_password" class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">Current Password</label>
                            ...
                            @if($errors->updatePassword->get('current_password'))
                                <p class="mt-2 text-sm text-red-600">{{ $errors->updatePassword->get('current_password')[0] }}</p>
                            @endif
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                @if($errors->updatePassword->get('password_confirmation'))
                                    <p class="mt-2 text-sm text-red-600">{{ $errors->updatePassword->get('password_confirmation')[0] }}</p>
                                @endif
                            </div>
                        </div>
