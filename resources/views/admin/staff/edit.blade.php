...
@section('content')
    <div class="container mx-auto max-w-4xl">
        <div class="flex items-center gap-4 mb-6">
            ...
            <h1 class="text-2xl font-bold text-slate-800 dark:text-white">Edit Staff</h1>
        </div>

        <div class="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 p-6">
            <form action="{{ route('admin.staffs.update', $staff->staff_id) }}" method="POST" enctype="multipart/form-data"
                class="space-y-6">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="flex items-center gap-4">
                            <div id="image-preview-container"
                                ...
                                @if($staff->image)
                                    <img id="image-preview" src="{{ Storage::url($staff->image) }}" alt="Staff Image"
                    ...
                    <div>
                        ...
                        <input type="text" name="pincode" value="{{ old('pincode', $staff->pincode) }}"
                            class="w-full rounded-lg border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-900 text-slate-800 dark:text-slate-200">
                ...
                <div>
                    ...
                    <textarea name="address" rows="3"
                        class="w-full rounded-lg border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-900 text-slate-800 dark:text-slate-200">{{ old('address', $staff->address) }}</textarea>
