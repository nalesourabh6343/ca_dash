    ...
    <div class="h-screen flex items-center justify-center bg-gradient-to-br from-red-50 to-slate-100 px-4">
        <div class="relative w-full max-w-sm bg-white/90 backdrop-blur rounded-2xl border border-slate-200 shadow-xl">
            ...
            <div class="px-8 pt-8 pb-6 text-center">
                ...
                <h1 class="text-2xl font-bold text-slate-900 tracking-tight">Admin Registration</h1>
                <p class="mt-1 text-sm text-red-600 font-medium">Create Control Account</p>
            </div>
            ...
            <div class="px-8 pb-8">
                <form method="POST" action="{{ route('register.admin') }}" class="space-y-5">
                    ...
                    <p class="text-center text-sm text-slate-500 mt-6">
                        Already have an account? <a href="{{ route('login.admin') }}"
                            class="font-semibold text-red-600 hover:underline">Sign in</a>
                    </p>
                </form>
            </div>
        </div>
