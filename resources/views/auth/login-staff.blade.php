    ...
    <div class="h-screen flex items-center justify-center bg-gradient-to-br from-emerald-50 to-slate-100 px-4">
        <div class="relative w-full max-w-sm bg-white/90 backdrop-blur rounded-2xl border border-slate-200 shadow-xl">
            ...
            <div class="px-8 pt-8 pb-6 text-center">
                ...
                <h1 class="text-2xl font-bold text-slate-900 tracking-tight">Staff Login</h1>
                <p class="mt-1 text-sm text-emerald-600 font-medium">Internal Workspace</p>
            </div>
            ...
            <div class="px-8 pb-8">
                ...
                <form method="POST" action="{{ route('login.staff') }}" class="space-y-5">
                    ...
                    <p class="text-center text-sm text-slate-500 mt-4">
                        Need an account? <a href="{{ route('register.staff') }}"
                            class="font-semibold text-emerald-600 hover:underline">Register here</a>
                    </p>
                </form>
            </div>
        </div>
