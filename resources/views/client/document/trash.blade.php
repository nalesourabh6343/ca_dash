    ...
    <div class="container mx-auto max-w-7xl">
        <div class="flex justify-between items-center mb-6">
            <div class="flex items-center gap-4">
                ...
                <h1 class="text-2xl font-bold text-slate-800 dark:text-white">Trashed Documents</h1>
            </div>
        </div>
                        ...
                        @forelse($documents as $doc)
                            <tr class="hover:bg-slate-50 dark:hover:bg-slate-700/50 transition">
                                ...
                                <td class="px-6 py-4 text-right space-x-2">
                                    <a href="{{ route('client.document.restore', $doc->document_id) }}" class="text-emerald-600 hover:text-emerald-800" title="Restore">
                                        <i class="fa-solid fa-rotate-left"></i> Restore
                                    </a>
                                    <a href="{{ route('client.document.forceDelete', $doc->document_id) }}" class="text-red-600 hover:text-red-800" title="Permanently Delete" onclick="return confirm('Are you sure? This cannot be undone.')">
