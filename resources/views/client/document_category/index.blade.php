    ...
    <div class="container mx-auto max-w-7xl">
        <div class="flex justify-between items-center mb-6">
            <div class="flex items-center gap-4">
                ...
                <h1 class="text-2xl font-bold text-slate-800 dark:text-white">Document Categories</h1>
            </div>
                        ...
                        @forelse($categories as $cat)
                            <tr class="hover:bg-slate-50 dark:hover:bg-slate-700/50 transition">
                                ...
                                <td class="px-6 py-4 text-right space-x-2">
                                    <a href="{{ route('client.category.edit', $cat->document_categorie_id) }}"
                                        class="text-indigo-600 hover:text-indigo-800" title="Edit">
                                        <i class="fa-solid fa-pen"></i>
                                    </a>
                                    <a href="{{ route('client.category.delete', $cat->document_categorie_id) }}"
                        ...
                        @empty
                            <tr>
                                <td colspan="4" class="px-6 py-12 text-center text-slate-500">
                                    <i class="fa-solid fa-tags text-3xl mb-3 opacity-50"></i>
