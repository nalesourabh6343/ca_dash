    ...
    <div class="container mx-auto max-w-7xl">
        <div class="flex justify-between items-center mb-6">
            <div class="flex items-center gap-4">
                <a href="{{ route('staff.client.index') }}"
                    class="p-2 rounded-full hover:bg-slate-100 dark:hover:bg-slate-700 transition">
                    <i class="fa-solid fa-arrow-left"></i>
                </a>
                <h1 class="text-2xl font-bold text-slate-800 dark:text-white">Trashed Clients</h1>
            </div>
        </div>
                        ...
                        @forelse($clients as $client)
                            <tr class="hover:bg-slate-50 dark:hover:bg-slate-700/50 transition">
                                ...
                                <td class="px-6 py-4 text-right space-x-2">
                                    <a href="{{ route('staff.client.restore', $client->client_id) }}"
                                        class="text-emerald-600 hover:text-emerald-800" title="Restore">
                                        <i class="fa-solid fa-rotate-left"></i> Restore
                                    </a>
                                    <a href="{{ route('staff.client.forceDelete', $client->client_id) }}"
